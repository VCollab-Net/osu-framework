...
{
    internal class VeldridSharedTexture : IVeldridTexture
    {
        ...
        public VeldridSharedTexture(IVeldridRenderer renderer, IntPtr texturePointer, uint width, uint height, PixelFormat format)
        {
            Renderer = renderer;
            Width = (int) width;
            Height = (int) height;
